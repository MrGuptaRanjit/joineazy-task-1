...
const getApiBaseUrl = () => {
  // If explicitly configured with environment variable, use it directly (e.g. on Vercel)
  if (import.meta.env.VITE_API_BASE_URL) {
    return import.meta.env.VITE_API_BASE_URL;
  }

  // If in browser and accessed via host IP or custom port (e.g. 10.84.157.240:3000)
